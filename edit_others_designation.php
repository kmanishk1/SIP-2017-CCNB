...
<html lang="en">
<head>
    <title>Edit Others' Designation (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<form action="save_others_designation.php" class="form" method="post">
    <input name="designation" type="text" class="form-control" placeholder="Designation" required/><br/>
