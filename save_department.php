...
if (!isset($_SESSION)) session_start();
    ...
    if (($_SESSION['userlevel'] === NULL) OR ($_SESSION['userlevel'] == 0)) {
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save Department's Name (Non-Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
        ...
        echo "<!DOCTYPE html>
            <html lang=\"en\">
            <head>
                <title>Save Department's Name (Admin) : CCNB</title>
                <meta charset=\"utf-8\">
                <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
                <link rel=\"stylesheet\" href=\"css/style.css\">
                <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">
...
if (isset($_POST['department']) AND isset($_POST['password']) AND isset($_SESSION['username'])) {
    ...
    if ($password === $pass) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, your <span style='color: dodgerblue'>Department's Name</span> has been updated successfully!</h3>";
            echo '
                                                    <div class="form">
                                                        <a href="edit_username.php" class="form2 btn btn-info btn-block">Change username</a>
                                                        <a href="edit_password.php" class="form2 btn btn-danger btn-block">Change password</a><br/>
