...
if (!isset($_SESSION)) session_start();
    ...
    if (($_SESSION['userlevel'] === NULL) OR ($_SESSION['userlevel'] == 0)) {
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save E-mail (Non-Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
        ...
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save E-mail (Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
                    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
                    <link rel=\"stylesheet\" href=\"css/style.css\">
                    <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">
...
?>
    ...
    <?php
        ...
        if (isset($_POST['email']) AND isset($_POST['password']) AND isset($_SESSION['username'])) {
            $email = $_POST['email'];
            ...
            if ($password === $pass) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $query1 = "UPDATE contact_info SET email='$email' WHERE departmentId='$departmentID'";
                    $result1 = mysqli_query($mysql, $query1) or die ("<h3>Sorry! Couldn't connect!</h3>");

                    echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, your <span style='color: dodgerblue'>E-mail</span> has been updated successfully!</h3>";
                    echo '
                                            <div class="form">
