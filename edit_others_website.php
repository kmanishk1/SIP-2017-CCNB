...
<html lang="en">
<head>
    <title>Edit Others' Website (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<body>
    ...
    <form action="save_others_website.php" class="form" method="post">
        <input name="website" type="url" class="form-control" placeholder="Profile's website" required/><br/>
