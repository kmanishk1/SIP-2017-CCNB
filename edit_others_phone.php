...
<html lang="en">
<head>
    <title>Edit Others' Phone number (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<form action="save_others_phone.php" class="form" method="post">
    <input name="phone" type="tel" class="form-control" placeholder="Phone number" required/><br/>
