...
if (!isset($_SESSION)) session_start();
    ...
    if (($_SESSION['userlevel'] === NULL) OR ($_SESSION['userlevel'] == 0)) {
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save Department's Description (Non-Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
        ...
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save Department's Description (Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
                    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
                    <link rel=\"stylesheet\" href=\"css/style.css\">
                    <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">
...
?>
    ...
    <?php
        ...
        if (isset($_POST['description']) AND isset($_POST['password']) AND isset($_SESSION['username'])) {
            ...
            if ($password === $pass) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $query1 = "UPDATE departments SET dep_description='$description' WHERE departmentId='$departmentID'";
                    $result1 = mysqli_query($mysql, $query1) or die ("<form action=\"edit_description.php\" method=\"post\"><button class=\"form1 btn btn-success btn-block\">Back</button></form>");

                    echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, your <span style='color: dodgerblue'>Department's description</span> has been updated successfully!</h3>";
                    echo '
                                            <div class="form">
