...
if (!isset($_SESSION)) session_start();
    ...
    if (($_SESSION['userlevel'] === NULL) OR ($_SESSION['userlevel'] == 0)) {
        echo "<!DOCTYPE html>
                    <html lang=\"en\">
                    <head>
                        <title>Save Profile Name (Non-Admin) : CCNB</title>
                        <meta charset=\"utf-8\">
        ...
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Save Profile Name (Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
                    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
                    <link rel=\"stylesheet\" href=\"css/style.css\">
                    <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">
    ...
    <?php
        ...
        if (isset($_POST['name']) AND isset($_POST['password']) AND isset($_SESSION['username'])) {
            ...
            if ($password === $pass) {
                ...
                $query = "UPDATE login_details SET name='$name' WHERE username='$username'";
                $result = mysqli_query($mysql, $query) or die ("<form action=\"edit_name.php\" method=\"post\"><button class=\"form1 btn btn-success btn-block\">Back</button></form>");

                    echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, your <span style='color: dodgerblue'>Profile Name</span> has been updated to <span style='color: dodgerblue'>".$name."</span>.</h3>";
                    echo '
                                            <div class="form">
