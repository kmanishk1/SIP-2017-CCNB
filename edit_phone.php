...
if (!isset($_SESSION)) session_start();
    ...
    if (($_SESSION['userlevel'] === NULL) OR ($_SESSION['userlevel'] == 0)) {
        echo "
                ...
                <html lang=\"en\">
                <head>
                    <title>Edit Phone number (Non-Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
                ...
                <form action=\"save_phone.php\" class=\"form\" method=\"post\">
                    <input name=\"phone\" type=\"tel\" class=\"form-control\" placeholder=\"Your Phone number\" required/><br/>
        ...
        echo "<!DOCTYPE html>
                <html lang=\"en\">
                <head>
                    <title>Edit Phone number (Admin) : CCNB</title>
                    <meta charset=\"utf-8\">
                    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
                    <link rel=\"stylesheet\" href=\"css/style.css\">
                    <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">
