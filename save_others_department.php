...
<html lang="en">
<head>
    <title>Save Others' Department's Name (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<body>
    <?php
        ...
        if (isset($_POST['department']) AND isset($_POST['password']) AND isset($_SESSION['departId'])) {
            ...
            if ($password === $pass) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $query1 = "UPDATE departments SET department='$department' WHERE departmentId='$departmentID'";
                    $result1 = mysqli_query($mysql, $query1) or die ("<h4 style='color: red; text-align: center'>or</h4><h3 style='text-align: center; color: coral; margin-bottom: 10px'>This department is already <span style='color: red'>associated</span> with other profile!</h3><div class=\"form\">
                                                ...
                                                <a href=\"edit_others_website.php\" class=\"form2 btn btn-primary btn-block\">Change your Website</a> 
                                                <a href=\"edit_others_phone.php\" class=\"form2 btn btn-primary btn-block\">Change Phone number</a>
                                                <a href=\"edit_others_email.php\" class=\"form2 btn btn-primary btn-block\">Change E-mail</a>
                                            </div>
                                            <form action=\"edit_others_user.php\" method=\"post\">
                                                <button class=\"form1 btn btn-success btn-block\">Back</button>
                                            </form>");

                    echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, you've updated <span style='color: dodgerblue'>".$name."</span>'s Department's Name successfully!</h3>";
                    echo '
                                                        <div class="form">
                                                            <a href="edit_others_username.php" class="form2 btn btn-info btn-block">Change username</a>
                                                            <a href="edit_others_password.php" class="form2 btn btn-danger btn-block">Change password</a><br/>
