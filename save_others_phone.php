...
<html lang="en">
<head>
    <title>Save Others' Phone number (Admin) : CCNB</title>
    <meta charset="utf-8">
...
if (isset($_POST['phone']) AND isset($_POST['password']) AND isset($_SESSION['departId'])) {
    $phone = $_POST['phone'];
    ...
    if ($password === $pass) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<h3 style='text-align: center; color: #2daae4; margin-bottom: 10px'>Dear <span style='color: dodgerblue'>" . $_SESSION['name'] . "</span>, you've updated <span style='color: dodgerblue'>".$name."</span>'s Phone number successfully!</h3>";
            echo '
                                                        <div class="form">
