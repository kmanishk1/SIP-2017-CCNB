...
<html lang="en">
<head>
    <title>Edit Others' E-mail (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<form action="save_others_email.php" class="form" method="post">
    <input name="email" type="email" class="form-control" placeholder="E-Mail ID" required/><br/>
