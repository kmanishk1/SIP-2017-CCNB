...
<html lang="en">
<head>
    <title>Edit Others' Department's Name (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<form action="save_others_department.php" class="form" method="post">
    <input name="department" type="text" class="form-control" placeholder="Department's Name" required/><br/>
