...
<html lang="en">
<head>
    <title>Edit Others' Department's Description (Admin) : CCNB</title>
    <meta charset="utf-8">
...
<form action="save_others_description.php" class="form" method="post">
    <textarea name="description" class="form-control" rows="5" placeholder="Department's Description" required></textarea><br/>
